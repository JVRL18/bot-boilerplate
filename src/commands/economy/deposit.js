...
const code = (user, userData, where, amount) => {
    if(userData.wallet < amount) return where.reply({embeds:[embed_404_error_message(`You do not have this much on your wallet, wallet money:\`${userData.wallet}💸\``)], ephemeral:true})
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("deposit")
        .setDescription("Saves your money on bank")
